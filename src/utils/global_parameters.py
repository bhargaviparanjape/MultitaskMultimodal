...
def add_args(parser):
	...
	files.add_argument('config-file', type=str, default=None)
	files.add_argument('--dataset', type=str, default=None)
	files.add_argument('--dataset-path', type=str, default=None)
